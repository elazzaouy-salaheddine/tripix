...
from destinations.models import Destination, Itinerary, CostIncludeExclude, FAQ, RelatedTrip, TourMap
from django.forms import inlineformset_factory
class DestinationForm(forms.ModelForm):
    class Meta:
        model = Destination
        fields = [
            'name', 'image', 'slug', 'location', 'accommodation',
            'best_season', 'duration_days', 'elevation',
            'tour_types', 'old_price', 'price', 'overview', 'published', 'tags'
        ]
